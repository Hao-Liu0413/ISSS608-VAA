...
#| eval: false
library(RODBC)
con <- odbcConnectAccess2007('Hands-on_Ex10/data/Coffee Chain.mdb')
coffeechain <- sqlFetch(con, 'CoffeeChain Query')
write_rds(coffeechain, "Hands-on_Ex10/data/CoffeeChain.rds")
odbcClose(con)
```
...
```{r}
coffeechain <- read_rds("Hands-on_Ex10/data/CoffeeChain.rds")
```

```{r echo=FALSE, eval=FALSE}
write_csv(coffeechain, "Hands-on_Ex10/data/coffeechain.csv")
```
